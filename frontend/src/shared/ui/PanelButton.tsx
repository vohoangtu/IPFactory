...
// Port của components/ui/shared/Button.tsx — đổi tên PanelButton để tránh đụng
// `@/shared/ui/Button` đã tồn tại (named export, API khác) đang được dùng ở
// src/app/login/page.tsx. Chỉ dùng nội bộ bởi EmptyState (action button, optional).
