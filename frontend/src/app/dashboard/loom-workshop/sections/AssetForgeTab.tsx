...
import { AssetForgeForm } from '@/components/dashboard/loom-workshop/asset-forge/AssetForgeForm';
import { AssetForgeResult } from '@/components/dashboard/loom-workshop/asset-forge/AssetForgeResult';
import type { AssetTabId, AssetForgeResult as AssetForgeResultType } from '@/components/dashboard/loom-workshop/asset-forge/types';
...
export default function AssetForgeTab() {
  ...
  const { actors } = useActors(activeUniverseId);
