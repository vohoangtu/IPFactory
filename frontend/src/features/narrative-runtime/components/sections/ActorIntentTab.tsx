...
interface ActorIntentTabProps {
  universeId: number | null;
}

export default function ActorIntentTab({ universeId }: ActorIntentTabProps) {
  ...
  const simulateIntent = async () => {
    ...
    try {
      const response = await apiClient.post('/loom/actor-intent', {
